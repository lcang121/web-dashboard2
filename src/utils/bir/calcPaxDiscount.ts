/**
 * Canonical pax discount calculation utility, ported from the mobile app
 * (utakmobileBIR/src/HelperFunctions/calcPaxDiscount.js).
 *
 * Accumulates per-part values as unrounded floats and rounds only the final
 * sums, so the totals match the device (e.g. VAT 64.29, not 64.28).
 */
...
export default calcPaxDiscount;
